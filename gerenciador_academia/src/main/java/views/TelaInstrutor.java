...
public class TelaInstrutor extends javax.swing.JPanel {
    ...
    public void traduzir(){
        ...
        lb_txtAdd.setText(this.traducoes.getString("lb_txtAddIns"));
        lb_txtAlterar.setText(this.traducoes.getString("lb_txtAlterarIns"));
        lb_txtMostrar.setText(this.traducoes.getString("lb_txtMostrarIns"));
    }
